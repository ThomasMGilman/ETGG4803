...
template<typename T> bool Utilities::chromosome<T>::operator>(Utilities::chromosome<T>& other)	const { return matches > other.matches; }
template<typename T> bool Utilities::chromosome<T>::operator<(Utilities::chromosome<T>& other)	const { return matches < other.matches; }
template<typename T> bool Utilities::chromosome<T>::operator==(Utilities::chromosome<T>& other)	const { return matches == other.matches; }
template<typename T> float Utilities::chromosome<T>::operator/(Utilities::chromosome<T>& other)	const { return (float)matches / (float)other.matches; }
template<typename T> float Utilities::chromosome<T>::operator/(float other)	const { return (float)matches / other; }