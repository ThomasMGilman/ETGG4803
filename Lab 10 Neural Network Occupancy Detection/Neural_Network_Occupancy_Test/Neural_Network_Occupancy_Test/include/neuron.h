...
public:
	...
	float get_weight(unsigned index) { return mWeights[index]; }
	...
	void set_error(float amnt) { mErrorAmnt = amnt; }
	...
	virtual float multiply_with_weight(unsigned index);
